...
class Processor(Iface, TProcessor):
  ...
  def process_refresh(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = refresh_result()
    result.success = self._handler.refresh()
    oprot.writeMessageBegin("refresh", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_process(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = process_result()
    result.success = self._handler.process(args.id)
...
class process_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (Process, Process.thrift_spec), None, ), # 0
  )
